        ...
        char** argv)
{
    ...
    int domain_id = 0;
    std::shared_ptr<TrackClassApplication> app;
    ...
    else
    {
        try
        {
            app = TrackClassApplication::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&TrackClassApplication::run, app);
