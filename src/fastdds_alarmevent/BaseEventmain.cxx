        ...
        char** argv)
{
    ...
    int domain_id = 0;
    std::shared_ptr<BaseEventApplication> app;
    ...
    else
    {
        try
        {
            app = BaseEventApplication::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&BaseEventApplication::run, app);
