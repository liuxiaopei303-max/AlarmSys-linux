        ...
        char** argv)
{
    ...
    int domain_id = 0;
    std::shared_ptr<AlarmEventApplication> app;
    ...
    else
    {
        try
        {
            app = AlarmEventApplication::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&AlarmEventApplication::run, app);
