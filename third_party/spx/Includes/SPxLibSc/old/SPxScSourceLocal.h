...
*
* File: $RCSfile: SPxScSourceLocal.h,v $
* ID: $Id: SPxScSourceLocal.h,v 1.78 2017/05/31 15:05:11 rew Exp $
*
* Purpose:
...
private:
    ...
    unsigned int m_bufferSizeBytes;		/* Not all used */
    ...
    unsigned char *m_pendingZoneBuffer;
    unsigned int m_pendingZoneBufferSizeBytes;
    unsigned int m_pendingZoneBufferUsedBytes;
    unsigned int m_numPendingZones;
